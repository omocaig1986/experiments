...
then
    ...
    wget https://github.com/openfaas/faas-cli/releases/download/0.13.13/faas-cli-armhf -O ~/bin/faas-cli
else
    wget https://github.com/openfaas/faas-cli/releases/download/0.13.13/faas-cli -O ~/bin/faas-cli
fi
